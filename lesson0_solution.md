...
**Решение**: Быстрое обновление поправленной задачи - асинхронно или банчами.
...
**Решение**: профилировать и найти проблему задержки расчетов, это должна быть быстрая операция, возможно использовать предварительный расчет с кэшированием промежуточных результатов.
...
**Решение**: Добавить базовые вещи - огирование ошибок, очереди повторов, мониторинг состояния сервисов. Возможно, пересмотреть границы сервисов с оценкой "цены" за это.
